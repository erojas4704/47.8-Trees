...
beforeEach(function () {
  ...
  let node6Reversed = new BinaryTreeNode(1);
  let node5Reversed = new BinaryTreeNode(1);
  let node4Reversed = new BinaryTreeNode(2);
  let node3Reversed = new BinaryTreeNode(3, node4Reversed, node6Reversed);
  let node2Reversed = new BinaryTreeNode(5);
  let node1Reversed = new BinaryTreeNode(5, node3Reversed, node5Reversed);
  let rootReversed = new BinaryTreeNode(6, node1Reversed, node2Reversed);
  largeTreeReversed = new BinaryTree(rootReversed);
});
...
describe("minDepth", function () {
  ...
  it("handles a certain case", () => {
    expect(largeTreeReversed.minDepth()).toBe(2);
  })
});
